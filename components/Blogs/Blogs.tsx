...
const Blogs = () => {
    return (
        <div className='Blogs w-full mb-32 mt-16'>
            ...
            <div className='Blogs_items mt-20 flex flex-row md:mr-12 gap-16 sm:mb-44 mb-16 lg:flex-nowrap flex-wrap'>
            ...
            <div className='Blogs_items sm:mt-20 flex flex-row md:mr-12 gap-16 lg:flex-nowrap flex-wrap'>
                <BlogsItem title='آخرین اخبار درباره صنعت بذر و پیشگامان این صنعت را میتوانید در این پست بخوانید'
                    category={['اخبار روز', 'دسته بندی 2']} color='#44A5DB'
                />
                <BlogsItem title='آخرین اخبار درباره صنعت بذر و پیشگامان این صنعت را میتوانید در این پست بخوانید'
