...
const HeroSectionText = () => {
    return (
        ...
        >
            <div className='text-5xl sm:text-7xl lg:text-9xl'>
                مسیرتان را
            </div>
            <div className='flex flex-row-reverse items-end gap-12 lg:gap-56'>
                <p className='text-5xl sm:text-7xl lg:text-9xl'> با ما </p>
                <Link href={'#AboutUs'}>
