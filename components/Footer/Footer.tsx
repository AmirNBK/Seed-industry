        ...
        >
            ...
            <div className='flex flex-wrap flex-row-reverse justify-center w-full gap-12 xl:gap-44 mt-12 xl:mt-32 justify-center'>
                ...
                {inView &&
                    ...
                    <div className={`${inView && 'animate__animated animate__slower animate__fadeInLeft'} Footer_leftSide flex flex-col gap-16 text-right justify-center px-6`}>
            ...
            {inView &&
                <div className={`${inView && 'animate__animated animate__slower animate__fadeInUp animate__delay-2s'} `}>
                    <hr className='mt-16' />
