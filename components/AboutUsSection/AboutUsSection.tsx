...
const AboutUs = (props: {
    ...
    return (
        <div
            className={`AboutUs md:p-0 px-4 ${myFont.className} md:items-end items-center mx-auto lg:mt-[-60px] mt-12 w-full md:w-4/5 lg:w-3/5 flex flex-col items-end xl:items-start xl:flex-row-reverse w-8/12 gap-8 md:gap-16 mb-20`}
            id='AboutUs'
        ...
        >
            ...
            <div className='flex flex-col items-end' data-aos="fade-right" data-aos-duration="1000" data-aos-once={true}>
                ...
                <div className='md:block flex justify-center md:w-full w-full'>
                    <RegularButton text='بیشتر بخوانید' link={'/about-us'} position='right' />
                </div>
            </div>
